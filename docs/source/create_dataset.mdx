...
🤗 Datasets supports many common formats such as `csv`, `json/jsonl`, `parquet`, `text`. (See the full list [here](https://huggingface.co/docs/datasets/en/package_reference/loading_methods#datasets.load_dataset.path).)
